...
namespace IndianStatesCensusTesting
{
    ...
    public class IndianStateAnalyzerTestCases
    {
        ...
        string stateCensusFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\IndianPopulation.csv";
        string wrongFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\WrongIndianPopulation.csv";
        string wrongTypeFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\IndiaStateCode.txt";
        string wrongDelimiterFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\DelimiterIndiaStateCensusData.csv";
        string wrongHeaderFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\WrongIndiaStateCensusData.csv";
        string stateCensusHeader = "State,Population,AreaInSqKm,DensityPerSqKm";

        //UC2 - File paths for indian state codes
        string statCodeFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\IndiaStateCode.csv";
        string wrongStateCodeFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\WrongIndiaStateCodeNotExist.csv";
        string wrongStateCodeTypeFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\IndiaStateCode.txt";
        string wrongStateCodeDelimiterFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\DelimiterIndiaStateCode.csv";
        string wrongStateCodeHeaderFilePath = @"C:\Users\CG-DTE\source\repos\IndianStatesCensusAnalyser\IndianStatesCensusAnalyser\CSVFile(s)\WrongIndiaStateCode.csv";
